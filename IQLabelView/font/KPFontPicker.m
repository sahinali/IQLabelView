...
NSString *const kDefaultFontName = @"Minnie";
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view;
{
    ...
    if (component == FontComponent) {
        ...
        string = fontName;
        if (self.pickerText.length > 0) {
            string = self.pickerText;
        }
        label.font = font;
...
- (NSArray *)colorList
{
    ...
    _colorList=  @[[UIColor blackColor], [UIColor grayColor],  [UIColor whiteColor],
                   [UIColor redColor],   [UIColor yellowColor], [UIColor greenColor],
                   [UIColor cyanColor],  [UIColor blueColor], [UIColor orangeColor],
                   [UIColor magentaColor],[UIColor purpleColor], [UIColor brownColor],
...
- (void)setpickerText:(NSString*)activeText
{
    self.pickerText = activeText;
